    ...
    <tbody>
      ...
      <tr>
        <td>
          <ul>
            <li>
              <a href="https://github.com/The-AI-Alliance/tapestry" target="_blank">repo</a>
            </li>
            <li>
              <a href="https://github.com/orgs/The-AI-Alliance/projects/50" target="_blank">dashboard</a>
            </li>
            <li>
              <a href="https://github.com/The-AI-Alliance/tapestry/issues" target="_blank">issues</a>
            </li>
            <li>
              <a href="https://github.com/The-AI-Alliance/tapestry/discussions" target="_blank">discussions</a>
            </li>
          </ul>
        </td>
        <td>
...
<div class="table-wrapper">
  <table>
    ...
    <tbody>
      <tr>
        <td class="project-title" colspan="2">
          <a href="https://www.thealliance.ai/projects" target="_blank">Open Models</a>
        </td>
      </tr>
      <tr>
        <td>
