...
In order for the objectives of the [Open Agent Hub]({{site.baseurl}}/open-agent-hub-projects/) and the [Open Models and Data Initiative]({{site.baseurl}}/open-models-and-data-projects/) to be achieved, fundamental requirements must be met for safety, governance, and the expertise required to use AI technologies effectively.
