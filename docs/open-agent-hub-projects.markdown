...
{% endcomment %}
# Agents and Applications Projects

> Collaborate, experiment, and build production-ready, open-source agentic applications.

The [**Agents and Applications**](https://the-ai-alliance.github.io/open-agent-hub/){:target="_blank"} website is a catalog of open-source tools and domain-specific examples for building successful agentic applications.
