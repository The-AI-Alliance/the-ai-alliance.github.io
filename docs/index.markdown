...
The [AI Alliance](https://thealliance.ai){:target="_blank"} Github organization, where you can learn, use, and contribute to our open-source AI projects.
...
The [Open Agent Hub](https://the-ai-alliance.github.io/open-agent-hub/){:target="oah"} is a collaborative community of open-source AI projects and domain-specific work groups that seek to make AI Agents successful in the real world through fast experimentation and distillation of learning into reusable reference architectures and enterprise-quality implementations.
